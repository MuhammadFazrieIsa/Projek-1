        ...
        <form id="PendaftaranForm" method="POST" action="simpandokumenpendaftaran.php" class="border p-4 rounded bg-light" enctype="multipart/form-data">
            <table class="table table-borderless">
                <tr>
                    ...
                    <td><input type="number" class="form-control" name="nomorpendaftaran" required=""></td>
                </tr>
                <tr>
                    <td>ID Pendaftaran</td>
                    <td><input type="number" class="form-control" name="idpendaftaran" required=""></td>
                </tr>
                ...
                <tr>
                    <td>File Dokumen</td>
                    <td><input type="file" class="form-control" name="filedok" id="fileDokumen" required=""></td>
                </tr>
                <tr>
                    <td>Keterangan Dokumen</td>
                    <td><input type="text" class="form-control" name="ketdok" required=""></td>
                </tr>
                <tr>
                    <td colspan="2">
