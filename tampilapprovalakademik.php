...
<header>
        ...
        <div class="right-content dropdown">
            ...
            <a class="dropdown-item btn btn-primary" data-toggle="modal" data-target="#laporanModal">Lapor</a>
            </div>
        </div>
...
<div class="modal" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title justify-content-center text-dark">Approve Akademik</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal Body (Form inside Modal) -->
            <div class="modal-body">
                <div class="container justify-content-center align-items-center col-sm-6" style="height: 55vh;">
                    <form id="InputPembimbing" method="POST" action="masukanakademik.php">
                        ...
                        <div class="form-group text-dark">
                            <label for="status_approve">Status</label>
