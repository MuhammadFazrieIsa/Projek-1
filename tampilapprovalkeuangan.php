...
<div class="modal" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title justify-content-center text-dark">Approve Keuangan</h4>
            ...
            <div class="modal-body">
                <div class="container justify-content-center align-items-center col-sm-6" style="height: 55vh;">
                    <form id="InputPembimbing" method="POST" action="masukankeuangan.php">
