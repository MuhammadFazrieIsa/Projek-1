...
<div class="container-fluid text-center col-sm-12">
    ...
    <?php
    include('koneksi.php'); 
    $query = "CALL SelectAllPendaftaran();";
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            // Include button to trigger modal and pass data
            echo "<td><button type='button' class='btn btn-primary' 
                        data-toggle='modal' data-target='#myModal'
                        onclick='setModalData(\"".$row['nim']."\")'>
                    Approve
                  </button></td>";
            echo "</tr>";
        }
...
<div class="modal" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title justify-content-center text-dark">Approve Pembimbing</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal Body (Form inside Modal) -->
            <div class="modal-body">
                <div class="container justify-content-center align-items-center col-sm-8" style="height: 60vh;">
                    <form id="InputPembimbing" method="POST" action="masukanpembimbing.php">
                        ...
                        <div class="form-group text-dark">
                            <label for="status_approve">Status Approve</label>
                            <input type="text" class="form-control" name="status_approve" required>
                        </div>

                        <div class="form-group text-dark">
                            <label for="tanggal_approve">Tanggal</label>
                            <input type="date" class="form-control" name="tanggal_approve" required>
                        </div>
                        ...
                        <div class="form-group text-dark">
                            <label for="sidang">Sidang Bikin</label>
                            <input type="text" class="form-control" name="sidang" required>
                        </div>
            ...
            <!-- Modal Footer (for any actions, like approve or cancel) -->
            <div class="modal-footer">
...
<script>
// Function to set the modal data dynamically
function setModalData(nim) {
    // Set the nim value in the modal form field
