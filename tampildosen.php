...
<div class="container-fluid text-center col-sm-12">
    <h1>Tampil Dosen</h1>
    <p>Silahkan Mengecek Dosen di bawah ini</p>
    <div class="row">
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='action-links'><a href='edit_dosen.php?id=" . $row["iddosen"] . "' class='btn btn-warning btn-sm'>Edit</a> | <a href='hapus_dosen.php?id=" . $row["iddosen"] . "' class='btn btn-danger btn-sm'>Hapus</a></td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='5' class='text-center'>Tidak ada data dosen</td></tr>";
            }
            ?>
        </tbody>
    </table>

    <!-- Link untuk kembali ke halaman tambah dosen -->
